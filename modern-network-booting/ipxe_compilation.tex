...
% \lstinputlisting[language=bash, caption={Installing build dependencies on Debian-based distributions}, label={lst:debian_build_dependencies}]{./install-build-deps.sh}
...
% \inputminted{bash}{./install-build-deps.sh}
