...
% When iPXE binary is compiled the default boot behavior is to wait a couple of second

% For automation purposes, it is essential to be able to provide initial commands that will be executed
