...
\usepackage{polski}          % Support for Polish language
% \usepackage[polish]{babel} % Adapts LaTeX to Polish typographical rules, the currency and comma decimal point are changed
